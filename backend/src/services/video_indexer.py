...
class VideoIndexerService:
    def __init__(self):
        ...
        # Use Service Principal if env vars are set (Docker/production)
        # Otherwise fall back to DefaultAzureCredential (local dev)
        tenant_id = os.getenv("AZURE_TENANT_ID")
        client_id = os.getenv("AZURE_CLIENT_ID")
        client_secret = os.getenv("AZURE_CLIENT_SECRET")

        if tenant_id and client_id and client_secret:
            print("🔑 Using Service Principal for Azure auth")
            ...
            print("🔑 Using DefaultAzureCredential for Azure auth (local dev)")
